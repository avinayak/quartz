...
assert_line '". c #707377",' "$test_tmp/custom/gtk-2.0/assets/button-disabled-pressed.xpm"
assert_line '"+ c #ccd2d9",' "$test_tmp/custom/gtk-2.0/assets/button-disabled-pressed.xpm"
